  ...
  do
    {
      ...
      deallog << "    second cell permutation = " << permutation_n << std::endl;
      ...
      FEFaceValues<3> ncell_face_values(mapping,
                                        fe,
                                        face_quad,
                                        update_quadrature_points);
        ...
        for (unsigned int f : cell->face_indices())
          {
            ...
            deallog << "        first face orientation = "
                    << int(cell->combined_face_orientation(f)) << std::endl;
            deallog << "        second face orientation = "
  ...
  for (unsigned int face_n = 0; face_n < 4; ++face_n)
    {
      ...
      do
        {
          deallog << "    first cell permutation = " << permutation_n
                  << std::endl;

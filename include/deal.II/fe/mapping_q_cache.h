...
public:
   ...
   *
   * The bool @p function_describes_relative_displacement is in the default
   * case false and indicates that the function @p transformation_function
   * maps to absolute coordinates.If the parameter is set to true, the return
   * value of the function is interpreted as relative deformation and the result

...
public:
   ...
   * element within the hp__DoFHandler.
   *
 ...
 * to be used with hp__DoFHandler in a domain with multiple, possibly
...
namespace ColorEnriched
{
  ...
  namespace internal
  {
     ...
     * associated with @p hp__DoFHandler i.e., if the subdomains share at least
     ...
     * @endcode
     *
     * @param[in] hp__DoFHandler object
     ...
     *
     * @param[in] dof_handler a hp__DoFHandler object
     ...
     * @p fe_sets of Helper class. Inputs are hp__DoFHandler object,
     ...
     *
     * @param[in] dof_handler hp__DoFHandler object
   ...
   * elements (hp::FECollection) to be used with hp__DoFHandler in a domain
   ...
   * objects to be used with an hp__DoFHandler object, can be retrieved
   * using the member function build_fe_collection which also modifies the
   * active FE indices of the hp__DoFHandler object (provided as an argument
   ...
   * hp__DoFHandler<dim> dof_handler(triangulation);
   *
  ...
  struct Helper
  {
    ...
    /**
     * Prepares an hp__DoFHandler object. The active FE indices of
     * mesh cells are initialized to work with
     * ColorEnriched::Helper<dim,spacedim>::fe_collection.
     *
     * @param dof_handler an hp__DoFHandler object
  ...
  private:
     ...
     * predicates and hp__DoFHandler object
     */
    std::vector<std::set<unsigned int>> fe_sets;
  };
} // namespace ColorEnriched

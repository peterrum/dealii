...
namespace parallel
{
   ...
   * cell varies, which is in general the case for hp__DoFHandler objects, we
   ...
   * a hp__DoFHandler. One can choose from predefined weighting
   ...
   * latter via hp__DoFHandler::initialize(), an assertion will be triggered in
  ...
  public:
     ...
     * Constructor.
     *
     * @param[in] dof_handler The hp__DoFHandler which will be used to
     ...
     *    hp__DoFHandler::cell_iterator. We require both to make sure to

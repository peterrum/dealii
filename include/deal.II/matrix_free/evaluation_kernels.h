    ...
    private:
      ...
      // clang-format off
                      ...
                      {{
                          ...
                          {{{{{{6,7,9,11}},{{2,3,9,11}}}},{{{{6,7,8,10}},{{2,3,8,10}}}}}},
                          {{{{{{4,5,10,11}},{{0,1,10,11}}}},{{{{4,5,8,9}},{{0,1,8,9}}}}}}
                       }};
                       
                      static constexpr std::array<std::array<std::array<std::array<unsigned int, 3>, 2>, 2>, 3> lines
                      {{
                          {{{{{{3,6,7}},{{2,3,7}}}},{{{{2,6,7}},{{2,3,6}}}}}},

                  ...
                  if (neighbor->level() < cell->level())
                    {
                      ...
                      for (unsigned int i = 0; i < dofs_per_face; ++i)
                        neighbor_dofs[i] =
                          neighbor_dofs_all[component_to_system_index_face(comp,
                                                                           i)];
          ...
          if (dim == 3)
            {
              ...
              // the edge mask, what is the types of the faces it belong to, and
              // what is the type along the edge.
              // clang-format off
              const unsigned int line_to_edge[12][4] = {
                {internal::constr_face_x | internal::constr_face_z, internal::constr_edge_zx, internal::constr_type_x | internal::constr_type_z, internal::constr_type_y},
                {internal::constr_face_x | internal::constr_face_z, internal::constr_edge_zx, internal::constr_type_z                          , internal::constr_type_y},
                {internal::constr_face_y | internal::constr_face_z, internal::constr_edge_yz, internal::constr_type_y | internal::constr_type_z, internal::constr_type_x},
                {internal::constr_face_y | internal::constr_face_z, internal::constr_edge_yz, internal::constr_type_z                          , internal::constr_type_x},
                {internal::constr_face_x | internal::constr_face_z, internal::constr_edge_zx, internal::constr_type_x                          , internal::constr_type_y},
                {internal::constr_face_x | internal::constr_face_z, internal::constr_edge_zx, 0                                                , internal::constr_type_y},
                {internal::constr_face_y | internal::constr_face_z, internal::constr_edge_yz, internal::constr_type_y                          , internal::constr_type_x},
                {internal::constr_face_y | internal::constr_face_z, internal::constr_edge_yz, 0                                                , internal::constr_type_x},
                {internal::constr_face_x | internal::constr_face_y, internal::constr_edge_xy, internal::constr_type_x | internal::constr_type_y, internal::constr_type_z},
                {internal::constr_face_x | internal::constr_face_y, internal::constr_edge_xy, internal::constr_type_y                          , internal::constr_type_z},
                {internal::constr_face_x | internal::constr_face_y, internal::constr_edge_xy, internal::constr_type_x                          , internal::constr_type_z},
                {internal::constr_face_x | internal::constr_face_y, internal::constr_edge_xy, 0                                                , internal::constr_type_z}};
              // clang-format on

    ...
    const bool                                      apply_constraints) const
{
  ...
  const unsigned int n_vectorization_actual =
    std::count_if(cells.begin(), cells.end(), [](const auto i) {

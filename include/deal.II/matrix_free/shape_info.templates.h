                              ...
                              const unsigned int        base_element_number)
    {
      ...
      if (quad_in.is_tensor_product() == false ||
          ...
          dynamic_cast<const Simplex::FE_DGP<dim> *>(&fe_in))
        {
          ...
          // a 1D quadrature rule. But this should be not a problem, since
          // that quadrature rule is not used anywhere.
          ...
          // TODO: also fill shape_hessians, shape_gradients_collocation,
          //   shape_hessians_collocation, shape_values_eo, shape_gradients_eo,
          //   shape_hessians_eo, shape_gradients_collocation_eo,
          //   shape_hessians_collocation_eo, inverse_shape_values,
          //   inverse_shape_values_eo, shape_data_on_face,
          //   quadrature_data_on_face, values_within_subface,
          //   gradients_within_subface,
          //   hessians_within_subface

          // indicate that no tensor product properties could be exploitet

...
namespace ReferenceCell
{
  ...
  /**
   * Return a default linear mapping matching the given reference cell (QGauss,
  ...
  /**
   * Return a default quadrature matching the given reference cell (MappingQ1
   * for hypercube cells and MappingFE else).
   */
  template <int dim>
  Quadrature<dim>
  get_default_quadrature(const Type &   reference_cell,

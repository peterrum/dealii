...
namespace internal
{
  namespace TriaAccessorImplementation
  {
    ...
    struct Implementation
    {
      ...
      inline static unsigned int
      line_index(const TriaAccessor<3, 3, spacedim> &accessor,
                 const unsigned int                  i)
      {
        const auto pair =
      ...
      template <int spacedim>
      inline static unsigned int
      quad_index(const TriaAccessor<3, 3, spacedim> &accessor,
                 const unsigned int                  i)
      {
      ...
      template <int spacedim>
      inline static bool
      face_orientation(const TriaAccessor<3, 3, spacedim> &accessor,
      ...
      template <int spacedim>
      inline static bool
      face_flip(const TriaAccessor<3, 3, spacedim> &accessor,
                const unsigned int                  face)
      {
        AssertIndexRange(face, accessor.n_faces());
      ...
      template <int spacedim>
      inline static bool
      face_rotation(const TriaAccessor<3, 3, spacedim> &accessor,
                    const unsigned int                  face)
      {
        AssertIndexRange(face, accessor.n_faces());
        Assert(accessor.present_index * GeometryInfo<3>::faces_per_cell + face <
      ...
      template <int spacedim>
      inline static void
      set_face_orientation(const TriaAccessor<3, 3, spacedim> &accessor,
                           const unsigned int                  face,
                           const bool                          value)
      {
        Assert(accessor.used(), TriaAccessorExceptions::ExcCellNotUsed());
      ...
      template <int spacedim>
      inline static void
      set_face_flip(const TriaAccessor<3, 3, spacedim> &accessor,
                    const unsigned int                  face,
                    const bool                          value)
      {
        AssertIndexRange(face, accessor.n_faces());
      ...
      template <int spacedim>
      inline static void
      set_face_rotation(const TriaAccessor<3, 3, spacedim> &accessor,
                        const unsigned int                  face,
                        const bool                          value)
      {
        AssertIndexRange(face, accessor.n_faces());
                           ...
                           const bool                          value)
      {
        Assert(accessor.used(), TriaAccessorExceptions::ExcCellNotUsed());
        AssertIndexRange(line, accessor.n_lines());
        Assert(accessor.present_index * accessor.n_lines() + line <
                 accessor.tria->faces->quads_line_orientations.size(),
               ExcInternalError());

        // quads as part of 3d hexes can have non-standard orientation
        accessor.tria->faces->quads_line_orientations[accessor.present_index *
                                                        accessor.n_lines() +
                                                      line] = value;
      }
      ...
      template <int spacedim>
      inline static void
      set_line_orientation(const TriaAccessor<3, 3, spacedim> &,
                           const unsigned int,
                           const bool)
      {
      ...
      template <int spacedim>
      inline static unsigned int
      vertex_index(const TriaAccessor<3, 3, spacedim> &accessor,
                   const unsigned int                  corner)
      {
        const auto pair =
...
template <int dim, int spacedim>
inline std::vector<TriaIterator<TriaAccessor<dim - 1, dim, spacedim>>>

...
CellAccessor<dim, spacedim>::global_active_cell_index_local() const
{
  return this->tria->levels[this->present_level]
...
CellAccessor<dim, spacedim>::global_active_cell_index() const
{
  ...
  const types::global_cell_index local_index =
    this->global_active_cell_index_local();
  ...
  if (const auto tria_parallel = dynamic_cast<
        ...
        &*this->tria))
    return tria_parallel->global_active_cell_index_partitioner()
...
template <int dim, int spacedim>
inline types::global_cell_index
CellAccessor<dim, spacedim>::global_level_cell_index_local() const
{
  return this->tria->levels[this->present_level]
...
{
  const types::global_cell_index local_index =
    this->global_level_cell_index_local();

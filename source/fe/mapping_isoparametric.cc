...
MappingIsoparametric<dim, spacedim>::InternalData::InternalData(
...
template <int dim, int spacedim>
std::size_t
MappingIsoparametric<dim, spacedim>::InternalData::memory_consumption() const
{
  return (
...
template <int dim, int spacedim>
void
MappingIsoparametric<dim, spacedim>::InternalData::initialize(
...
template <int dim, int spacedim>
void
MappingIsoparametric<dim, spacedim>::InternalData::initialize_face(
  const UpdateFlags      update_flags,
  const Quadrature<dim> &q,
  const unsigned int     n_original_q_points)
{
...
template <int dim, int spacedim>
void
MappingIsoparametric<dim, spacedim>::InternalData::
...
namespace internal
{
  namespace MappingIsoparametricImplementation
  {
    namespace
    {
      /**
...
MappingIsoparametric<dim, spacedim>::clone() const
{
  return std::make_unique<MappingIsoparametric<dim, spacedim>>(*this);
}
...
template <int dim, int spacedim>
unsigned int
MappingIsoparametric<dim, spacedim>::get_degree() const
{
...
template <int dim, int spacedim>
Point<spacedim>
MappingIsoparametric<dim, spacedim>::transform_unit_to_real_cell(
...
template <int dim, int spacedim>
Point<dim>
MappingIsoparametric<dim, spacedim>::transform_real_to_unit_cell(
  const typename Triangulation<dim, spacedim>::cell_iterator &cell,
...
template <int dim, int spacedim>
UpdateFlags
MappingIsoparametric<dim, spacedim>::requires_update_flags(
...
MappingIsoparametric<dim, spacedim>::get_data(const UpdateFlags update_flags,
...
template <int dim, int spacedim>
std::unique_ptr<typename Mapping<dim, spacedim>::InternalDataBase>
MappingIsoparametric<dim, spacedim>::get_face_data(
  const UpdateFlags          update_flags,
...
template <int dim, int spacedim>
std::unique_ptr<typename Mapping<dim, spacedim>::InternalDataBase>
MappingIsoparametric<dim, spacedim>::get_subface_data(
  const UpdateFlags          update_flags,
  const Quadrature<dim - 1> &quadrature) const
{
  std::unique_ptr<typename Mapping<dim, spacedim>::InternalDataBase> data_ptr =
...
MappingIsoparametric<dim, spacedim>::fill_fe_values(
  const typename Triangulation<dim, spacedim>::cell_iterator &cell,
  const CellSimilarity::Similarity                            cell_similarity,
            ...
            if (dim == spacedim)
              {
                ...
                // TODO[peterrum] : cell->diameter() not implemented yet
                Assert(det >
...
namespace internal
{
  namespace MappingIsoparametricImplementation
  {
    namespace
    {
      ...
      /**
       * Do the work of MappingIsoparametric::fill_fe_face_values() and
       * MappingIsoparametric::fill_fe_subface_values() in a generic way,
...
template <int dim, int spacedim>
void
MappingIsoparametric<dim, spacedim>::fill_fe_face_values(
  const typename Triangulation<dim, spacedim>::cell_iterator &cell,
  const unsigned int                                          face_no,
  const Quadrature<dim - 1> &                                 quadrature,
  const typename Mapping<dim, spacedim>::InternalDataBase &   internal_data,
    ...
    &output_data) const
{
  ...
  internal::MappingIsoparametricImplementation::do_fill_fe_face_values(
    *this,
    cell,
    face_no,
...
template <int dim, int spacedim>
void
MappingIsoparametric<dim, spacedim>::fill_fe_subface_values(
  const typename Triangulation<dim, spacedim>::cell_iterator &cell,
  const unsigned int                                          face_no,
  const unsigned int                                          subface_no,
  const Quadrature<dim - 1> &                                 quadrature,
  ...
  namespace MappingIsoparametricImplementation
  {
    namespace
    {
        ...
        const ArrayView<Tensor<rank, spacedim>> &                output)
      {
        ...
        Assert(
          (dynamic_cast<const typename dealii::
                          MappingIsoparametric<dim, spacedim>::InternalData *>(
             &mapping_data) != nullptr),
          ExcInternalError());
        const typename dealii::MappingIsoparametric<dim, spacedim>::InternalData
          &data =
            static_cast<const typename dealii::
                          MappingIsoparametric<dim, spacedim>::InternalData &>(
              mapping_data);
...
template <int dim, int spacedim>
void
MappingIsoparametric<dim, spacedim>::transform(
  const ArrayView<const Tensor<1, dim>> &                  input,
  const MappingKind                                        mapping_kind,
  const typename Mapping<dim, spacedim>::InternalDataBase &mapping_data,
  const ArrayView<Tensor<1, spacedim>> &                   output) const
{
  internal::MappingIsoparametricImplementation::transform_fields(input,
                                                                 mapping_kind,
                                                                 mapping_data,
                                                                 output);
}
...
{
  internal::MappingIsoparametricImplementation::transform_differential_forms(
  ...
  const ArrayView<Tensor<2, spacedim>> &                   output) const
{
  switch (mapping_kind)
    {
      case mapping_contravariant:
        internal::MappingIsoparametricImplementation::transform_fields(
          input, mapping_kind, mapping_data, output);
        return;
      ...
      case mapping_contravariant_gradient:
      case mapping_covariant_gradient:
        internal::MappingIsoparametricImplementation::transform_gradients(
          input, mapping_kind, mapping_data, output);
        return;
      default:
        Assert(false, ExcNotImplemented());
  ...
  switch (mapping_kind)
    {
      ...
      case mapping_contravariant_hessian:
      case mapping_covariant_hessian:
        internal::MappingIsoparametricImplementation::transform_hessians(
          input, mapping_kind, mapping_data, output);
        return;
      default:
        Assert(false, ExcNotImplemented());
...
MappingIsoparametric<dim, spacedim>::compute_mapping_support_points(
...
#include "mapping_isoparametric.inst"

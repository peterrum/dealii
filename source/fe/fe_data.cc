...
FiniteElementData<dim>::FiniteElementData(
  ...
  , first_quad_index(data.first_index[2][0])
  , first_index_of_quads(data.first_index[2])
  , first_hex_index(data.first_index[3][0])
  , first_face_line_index(data.first_face_index[1][0])
  , first_line_index_of_faces(data.first_face_index[1])
  , first_face_quad_index(data.first_face_index[2][0])

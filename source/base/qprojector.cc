  ...
  const hp::QCollection<2> &quadrature)
{
  ...
  SubQuadrature q_reflected = reflect(quadrature[0 /*TODO*/]);
  SubQuadrature q[8]        = {quadrature[0 /*TODO*/],
                        rotate(quadrature[0 /*TODO*/], 1),
                        rotate(quadrature[0 /*TODO*/], 2),
                        rotate(quadrature[0 /*TODO*/], 3),
                        q_reflected,

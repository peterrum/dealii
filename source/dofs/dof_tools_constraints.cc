...
namespace DoFTools
{
  ...
  void
  make_periodicity_constraints(const DoFHandler<dim, space_dim> & dof_handler,
                               ...
                               const number         periodicity_factor)
  {
    ...
    std::vector<GridTools::PeriodicFacePair<
      typename DoFHandler<dim, space_dim>::cell_iterator>>
      matched_faces;
    ...
    make_periodicity_constraints<DoFHandler<dim, space_dim>>(
      matched_faces,
      constraints,
      component_mask,
